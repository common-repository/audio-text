...
if( !defined( 'AUD_TXT_DIR' ) ) {
  define( 'AUD_TXT_DIR', dirname( __FILE__ ) );      // Plugin dir
}
if( !defined( 'AUD_TXT_VERSION' ) ) {
  define( 'AUD_TXT_VERSION', '1.0' );      // Plugin Version
}
if( !defined( 'AUD_TXT_URL' ) ) {
  define( 'AUD_TXT_URL', plugin_dir_url( __FILE__ ) );   // Plugin url
}
if( !defined( 'AUD_TXT_INC_DIR' ) ) {
  define( 'AUD_TXT_INC_DIR', AUD_TXT_DIR.'/includes' );   // Plugin include dir
}
if( !defined( 'AUD_TXT_INC_URL' ) ) {
  define( 'AUD_TXT_INC_URL', AUD_TXT_URL.'includes' );    // Plugin include url
}
if( !defined( 'AUD_TXT_ADMIN_DIR' ) ) {
  define( 'AUD_TXT_ADMIN_DIR', AUD_TXT_INC_DIR.'/admin' );  // Plugin admin dir
}
if(!defined('AUD_TXT_PREFIX')) {
  define('AUD_TXT_PREFIX', 'AUD_TXT'); // Plugin Prefix
}
if(!defined('AUD_TXT_VAR_PREFIX')) {
  define('AUD_TXT_VAR_PREFIX', '_AUD_TXT_'); // Variable Prefix
}
